...
<style>
  ...
  .signup-page input {
    width: 90%; /* pak më të shkurtra horizontalisht */
    padding: 16px 15px; /* rrit lartësinë */
    margin: 10px auto;
    display: block;
    border-radius: 8px;
...
width: 90;
  ...
  .checkboxLabel {
  display: flex;
  align-items: center; /* rreshton checkbox dhe tekst vertikalisht */
  gap: 10px;           /* hapësira mes checkbox dhe tekstit */
  width: 80%;           /* njëjtë si inputet, për t’u qendruar në mes */
...
.checkboxLabel input[type="checkbox"] {
  width: 18px;   /* bën checkbox më të madh */
  height: 18px;
  flex-shrink: 0;
}
...
signup-page input:focus {
  border-color: #007bff; /* blu kur është në fokus */
  outline: none;
}

.signup-page input:valid {
  border-color: #007bff; /* blu kur inputi është valid */
}
